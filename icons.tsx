...
export const Gamepad2Icon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M17.32 5H6.68a4 4 0 0 0-3.97 3.59c-.2.95.18 1.92 1 2.41L6 12l-2.29 1c-.82.49-1.2.14-1-1.41a4 4 0 0 0-3.97-3.59H2" transform="rotate(90 12 12)" />
    <path d="m17.32 5-2.29 1.41c-.82.49-1.2.14-1-1.41A4 4 0 0 0 9.32 2H6.68a4 4 0 0 0-3.97 3.59C2.51 6.54 2.89 7.5 4 8l2.29 1" />
  </svg>
);
